...
public class DutchElectionParser {
    ...
    /**
     * Creates an empty parser with no transformers.
     * Transformers can be set using the setter methods.
     */
    public DutchElectionParser() {
        // No transformers set by default
    }
     ...
     */
    // TODO See the DutchElectionServiceImpl for some refactoring hints for this constructor.
    public DutchElectionParser(
            ...
            VotesTransformer partyVotesTransformer) {
    ...
    // Setter methods for individual transformers
    public DutchElectionParser withDefinitionTransformer(DefinitionTransformer transformer) {
        this.definitionTransformer = transformer;
        return this;
    }

    public DutchElectionParser withCandidateTransformer(CandidateTransformer transformer) {
        this.candidateTransformer = transformer;
        return this;
    }

    public DutchElectionParser withPartyVotesTransformer(VotesTransformer transformer) {
        this.partyVotesTransformer = transformer;
        return this;
    }

    public DutchElectionParser withResultTransformer(VotesTransformer transformer) {
        this.resultTransformer = transformer;
        return this;
    }

    public DutchElectionParser withNationalVotesTransformer(VotesTransformer transformer) {
        this.nationalVotesTransformer = transformer;
        return this;
    }

    public DutchElectionParser withConstituencyVotesTransformer(VotesTransformer transformer) {
        this.constituencyVotesTransformer = transformer;
        return this;
    }

    public DutchElectionParser withMunicipalityVotesTransformer(VotesTransformer transformer) {
        this.municipalityVotesTransformer = transformer;
        return this;
    }
...
//
        ...
        if (partyVotesTransformer != null) {
            parseFiles(folderName, "Totaaltelling_%s".formatted(electionId), new EMLHandler(partyVotesTransformer));
        }
