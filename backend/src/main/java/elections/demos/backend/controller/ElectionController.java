...
import elections.demos.backend.service.DutchElectionServiceImpl;
...
public class ElectionController {
    ...
    public ElectionController(DutchElectionServiceImpl electionService) {
    ...
    public List<ExistingElectionDTO> getAvailableElections() {
        return electionService.getAvailableElections();
    }
